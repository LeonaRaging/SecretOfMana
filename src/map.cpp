...
map dragon_cave_1()
{
	map p_map = createMap("dragon_cave_1", 43, 40);
...
map dragon_cave_2()
{
	map p_map = createMap("dragon_cave_2", 38, 37);
...
map dragon_cave_3()
{
	map p_map = createMap("dragon_cave_3", 51, 41);
...
map dragon_cave_4()
{
	map p_map = createMap("dragon_cave_4", 19, 19);
